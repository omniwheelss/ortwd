										...
										if(count($Device_List_Array) > 0){										
											...
											if($device_count2>=1){
												...
												while($Vehicle_Summary_Array = mysql_fetch_array($Mysql_Query_Result2)){
													...
													// Moving Status
													if($Vehicle_Summary_Array['speed'] > 10 && $Vehicle_Summary_Array['ign'] == 1){
														$Vehicle_Summary_Array['status'] = "Moving";
														$Vehicle_Summary_Array['ign'] = "On";
														$Vehicle_Summary_Array['status_icon'] = "green.png";
													}
													// Stopped Status
													else if($Vehicle_Summary_Array['speed'] == 0  && $Vehicle_Summary_Array['ign'] == 0 && $Alert_Msg_Code[0] != 'VI'){
													...
													// Idle Status
														...
														($Vehicle_Summary_Array['speed'] <= 10 && $Vehicle_Summary_Array['ign'] == 1) || $Alert_Msg_Code[0] == 'VI'){
